...
export default function App() {
  ...
  if (page === 'course-workspace' && selectedCourse) return <CourseWorkspace course={selectedCourse} onBack={() => setPage('workspace')} onCourses={openCourseFolders} onOpenCollection={openCollection} onOpenNote={openCourseNote} onUpdateCourse={updateCourse} onDelete={() => deleteCourse(selectedCourse.id)} onMore={() => setAction('course-more')} />;
